...
@section('container')
    <h1 class="text-4xl mb-4">Tambah Karyawan</h1>

    <form method="post" action="/karyawan" class="max-w-xl">
        @csrf
        ...
        <button type="submit"
            class="text-white my-6 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
